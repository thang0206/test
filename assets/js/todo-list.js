...
function addItemAction(item) {
    item.querySelector('.item-checkbox').addEventListener('click', addCheckboxAction)
    item.querySelector('.edit-item-button').addEventListener('click', addEditAction)
    item.querySelector('.delete-item-button').addEventListener('click', addDeleteAction)
}
